...
* In Cloud Console select Network Services -> Load Balancing
    ...
    * Make sure the load balancer reports the backends as healthy
        ...
        * Check that health checks are properly configured
          ...
          * See [K8s docs](https://github.com/kubernetes/contrib/blob//ingress/controllers/gce/examples/health_checks/README.md#limitations) for important information about how health checks are determined from readiness probes.
